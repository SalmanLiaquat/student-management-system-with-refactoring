...
class StudentManager:
    ...
    def class_topper_report(self):
        ...
        topper = None
        for student in self.students:
            if student.calculate_average() > highest_avg:
                highest_avg = student.calculate_average()
                topper = student
...
def input_student_data():
    ...
    for i in range(total_subjects):
        ...
        # Inline grade calculation (from previous step)
...
def main_app_loop():
    ...
    print("\n*****************************************************************")
    print("* WELCOME TO THE STUDENT RECORD MANAGEMENT SYSTEM V5.0 ALPHA     *")
    print("*****************************************************************")
