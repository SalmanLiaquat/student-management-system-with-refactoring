...
class StudentManager:
    ...
    def grade_distribution(self):
        ...
        for grade in grade_count:
            print("Grade", grade, ":", grade_count[grade])
...
def main_app_loop():
    ...
    print("\n*****************************************************************")
    print("* WELCOME TO THE STUDENT RECORD MANAGEMENT SYSTEM V2.0 ALPHA     *")
    print("*****************************************************************")
    ...
    while True:
        ...
        if choice == "1":
            ...
            student_manager.grade_distribution()

        elif choice == "6":
            student_manager.class_topper()
            ...
            student_manager.search_by_name(search_name)
