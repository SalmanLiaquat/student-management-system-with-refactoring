...
class StudentManager:
    ...
    def grade_distribution_report(self):
        ...
        for student in self.students:
            for subject in student.subjects:
                grade = subject['grade']
                grade_count[grade] += 1
        self._print_grade_distribution(grade_count)

    def _print_grade_distribution(self, grade_count):
        print("\n--- GRADE DISTRIBUTION REPORT ---")
        for grade, count in grade_count.items():
            print("Grade", grade, ":", count)

    def class_topper_report(self):
        topper = self._find_class_topper()
        if topper:
            print("\n--- CLASS TOPPER ---")
    ...
    def pass_fail_report(self):
        pass_count, fail_count = self._calculate_pass_fail()
        print("\n--- PASS / FAIL REPORT ---")
        print("Passed Students:", pass_count)
        print("Failed Students:", fail_count)

    def _calculate_pass_fail(self):
    ...
    # ----------------- Extracted Methods for Update/Search -----------------
...
def input_subject_data(student):
...
def main_app_loop():
    ...
    print("\n*****************************************************************")
    print("* WELCOME TO THE STUDENT RECORD MANAGEMENT SYSTEM V3.0 ALPHA     *")
    print("*****************************************************************")
